...
public class ReadData extends ListActivity {
    ...
    String url = "http://52.198.30.224/read_employee.php";
    ArrayList<HashMap<String, String>> Item_List;
    ProgressDialog PD;
    ListAdapter adapter;

    // JSON Node names
    public static final String ITEM_ID = "NFCTagID";
    public static final String ITEM_EMP = "EmployeeID";
    public static final String ITEM_NAME = "EmployeeName";
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                for (int i = 0; i < ja.length(); i++) {
                                    ...
                                    item.put(ITEM_EMP, jobj.getString(ITEM_EMP));
                                    item.put(ITEM_NAME, jobj.getString(ITEM_NAME));
                                    Item_List.add(item);

                                } // for loop ends

                                String[] from = { ITEM_ID, ITEM_EMP, ITEM_NAME };
                                int[] to = { R.id.item_id, R.id.item_emp, R.id.item_name };
